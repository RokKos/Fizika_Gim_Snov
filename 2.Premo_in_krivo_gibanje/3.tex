...
To je gibanje pri katerem je \textbf{hitrost konstantna}. Telo v enakih časovnih intervalih naredi enako pot. Primer: krogla, ki jo iztrelimo v breztežnostnem prostoru.\\
\begin{align*}
	a &=0\\
	v &= v_0\\
	s &= v_0t \rightarrow v_0 = \frac{s}{t}\\
	v^2 &= v_0^2\\
\end{align*}
