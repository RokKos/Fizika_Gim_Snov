...
\usepackage{units}
\usepackage{siunitx}
%da so lahko enote samostojno
\sisetup{free-standing-units}

%\usepackage{tgbonum}

%\fontfamily{\familydefault}
%\renewcommand{\familydefault}{\familydefault} %drugace font
\usefont{T1}{cmr}{b}{n}
...
\begin{document}
	...
	\foreach \n in {1,...,5}{
		\subimport{14.Nihanje/}{\n.tex}
	}

	{\color{internationalorange}\section{VALOVANJE}}
	\foreach \n in {1,...,5}{
		\subimport{15.Valovanje/}{\n.tex}
	}

	%TODO: -popravi pisavo(se cisto malo)
	%	-komanda za rdec kvadrat
	%	-komanda za rdece oznacevanje teksta
	%	-popravit naslove in podnaslove
	%	-popravit enote z packagom units
\end{document}